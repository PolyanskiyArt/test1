...
$date_registr = date('Y-m-d H:i:s');
 ...
 // если такого нет, то сохраняем данные
    ...
    $result2 = mysql_query ("INSERT INTO users (nick_name,password,cont_icq,cont_vk,cont_odn,cont_skype,city,cont_spec,date_registration,date_last,nkarta,nyandex,nqiwi,linking,ip,is_avtor) VALUES('$login','$password','$cont_icq','$cont_vk','$cont_odn','$cont_skype','$cont_city','$cont_spec','$date_registr','$date_registr','$nkarta','$nyandex','$nqiwi','$link','$ip',1)");
